...
vantagens sobre seus concorrentes. Criptografá-la para o não acesso
por terceiro, se tornou necessário para a confiabilidade da
transmissão da informação e da privacidade dos indivíduos. Assim como
...
utilização da CPU. A figura abaixo ilustra o processo de criptografia
assimétrica.
...
com criptografia ponto a ponto (P2P), os riscos são amplificados. A
...
estruturas descentralizadas ou ponto a ponto (P2P), enfrentam
...
Portanto, o uso de criptografia de ponta a ponta (end-to-end
...
descentralizados ou ponto a ponto (P2P), onde não há um servidor
...
A aplicação desenvolvida neste trabalho adota a arquitetura P2P com
criptografia de ponta a ponta (E2EE), o que garante que apenas os
...
moderna segundo legislações como a LGPD (Lei Geral de Proteção de
Dados). Em vez de armazenar o conteúdo das mensagens, o sistema
...
A utilização de criptografia fim a fim (E2EE) se destaca por sua
...
judiciais de conteúdo. No entanto, a arquitetura E2EE rompe com
...
criptografia de ponta a ponta (E2EE) é um padrão de segurança para
...
intermediária”\footnote{End-to-end encryption (E2EE) is a standard
...
"problema do intermediário confiável". Na prática, E2EE
...
estabelecidos por regulamentações como a LGPD (Lei nº
13.709/2018) no Brasil e o Regulamento Geral de Proteção de Dados
(GDPR) da União Europeia. Ambas as legislações reforçam o conceito
...
A criptografia E2EE, ao garantir que os dados em trânsito sejam
...
dados em sistemas E2EE devem ser sempre opcionais e precedidas de
