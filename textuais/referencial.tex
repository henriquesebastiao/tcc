\section{REFERENCIAL TEÓRICO}\label{ch:referencial}

\subsection{Criptografia de mensagens}

Há muitos anos, a informação é uma ferramenta crucial para se obter
...
informações sigilosas é uma prática que remonta aos primórdios da
...
Aplicações de ponta adotam a arquitetura \acs{P2P} com criptografia de
ponta a ponta (\acs{E2EE}), o que garante que apenas os dispositivos dos
usuários tenham acesso ao conteúdo das mensagens. Entretanto, a
ausência de um intermediário confiável exige o uso de assinaturas
digitais como mecanismo de validação direta entre as partes,
assegurando que o conteúdo recebido não foi alterado durante o
tráfego e, mais ainda, que foi gerado pelo remetente legítimo.
...
proposta neste trabalho, deve ser tratada desde a concepção do
sistema, incorporando práticas como \textit{\gls{privacybydesign}} e
\textit{\gls{privacybydefault}}, promovendo a privacidade como um
requisito estrutural da
arquitetura, e não como uma funcionalidade opcional ou complementar.
Nesse contexto, o sistema implementa validações automatizadas, limita
o armazenamento de dados sensíveis, adota criptografia robusta e
evita qualquer exposição desnecessária do conteúdo ao servidor,
garantindo não apenas a funcionalidade da comunicação, mas também a
confiança dos usuários, o fortalecimento da segurança técnica e a
conformidade legal.
...
relacionamentos. Essas transformações só foram possíveis graças ao
...
graças à comunicação moderna. Para garantir que as mensagens cheguem
...
digital contemporânea é a capacidade de interatividade em tempo
real. A troca contínua de informações entre sistemas e usuários
permite que interações provém de maneira natural, como em conversas
...
O protocolo Websocket\footnote{WebSocket:
\link{https://websocket.org/}} documentado na RFC 6455\footnote{RFC 6455:
\link{https://tools.ietf.org/html/rfc6455}} em 2011 pela
...
O Python\footnote{Python: \link{https://www.python.org/}}, principal
...
biblioteca Cryptography\footnote{Cryptography:
\link{https://cryptography.io/en/latest/}}, amplamente reconhecida na
comunidade Python
...
O FastAPI\footnote{FastAPI: \link{https://fastapi.tiangolo.com/}} foi
a tecnologia escolhida para o desenvolvimento do
...
validação automática via Pydantic\footnote{Pydantic:
\link{https://docs.pydantic.dev/latest/}}, documentação interativa gerada
...
ferramenta Docker\footnote{Docker: \link{https://www.docker.com/}}.
Lançado em 2013, o Docker é uma plataforma de
